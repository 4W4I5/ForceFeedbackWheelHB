...
// Pin definitions
const byte ZeroPin = 4;  // RS422 input for Z channel (zero detection)
const byte COSPin = 2;   // RS422 input for A channel (cos signal) 
const byte SINPin = 3;   // RS422 input for B channel (sin signal)  
